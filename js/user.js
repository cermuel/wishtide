...
let currentUsername = getUsernameFromHash();
let isFollowed = false;
let selectedTab = "wishlists";
...
function updateFollowButton() {
  ...
  if (isFollowed) {
    ...
    followText.textContent = `Follow ${currentUsername}`;
  }
}

function updateUserInfo() {
  const usernameElement = document.getElementById("username");
  const followTextElement = document.getElementById("followText");
  ...
  if (followTextElement) {
    followTextElement.textContent = isFollowed
      ? "Unfollow"
  ...
  const followBtn = document.getElementById("followBtn");
  if (followBtn) {
    followBtn.className = isFollowed
      ? "follow-btn unfollow"
      : "follow-btn follow";
  }
}
          ...
          <section class="card-content">
            <div class="user-info">
              ...
              <div class="ms-auto d-flex align-items-center gap-1">
                ...
                ${home.createOverlappingAvatars(event.tagged, "likes-avatars")}
              </div>
            </div>
            <div class="event-tags">
              ...
              <span class="event-tag d-none d-md-inline">${event.status}</span>
              <span class="event-tag">RSVP count: ${event.RSVP_count}</span>
            </div>
            ...
            <div class="progress-section">
              ...
              <div class="progress-bar-container">
                <div class="progress-bar" style="width: ${
                  (event.gift.progress / event.gift.target) * 100
                }%;"></div>
              </div>
      ...
      .map(
        ...
        <div class="contribution-card">
          ...
          <div class="contribution-progress">
            <div class="progress-bar-container">
              <div class="progress-bar" style="width: ${
                (contribution.gift.progress / contribution.gift.target) * 100
              }%;"></div>
            </div>
            <div class="progress-text">
              <span>Contributed: <span style="color: #151515;">$${
...
window.addEventListener("hashchange", function () {
  currentUsername = getUsernameFromHash();
  updateUserInfo();
});
